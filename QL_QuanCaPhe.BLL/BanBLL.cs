...
namespace QL_QuanCaPhe.BLL
{
    ...
    public class BanBLL
    {
        ...
        public DataTable LoadData()
        {
            try
            {
                BanDAO objBanDAO = new BanDAO();
                return objBanDAO.LoadData();
            }
        ...
        public DataTable Search(int intSearchType, string strKeyWord)
        {
            ...
            {
                BanDAO objBanDAO = new BanDAO();
                return objBanDAO.Search(intSearchType, strKeyWord);
            }
            catch (Exception objEx)
            {
                return null;
        ...
        public bool CapNhatTrangThaiBan(int MaBan, string TrangThai)
        {
            ...
            {
                BanDAO objBanDAO = new BanDAO();
                return objBanDAO.CapNhatTrangThaiBan(MaBan, TrangThai);
            }
            catch (Exception objEx)
            {
                return false;
        ...
        public BanBO LayThongTinBan(int MaBan)
        {
            ...
            {
                BanDAO objBanDAO = new BanDAO();
                return objBanDAO.LayThongTinBan(MaBan);
            }
            catch (Exception objEx)
            {
                return null;
        ...
        public DataTable LayThongTinTinhTrangBan(int MaBan)
        {
            ...
            {
                BanDAO objBanDAO = new BanDAO();
                return objBanDAO.LayThongTinTinhTrangBan(MaBan);
            }
            catch (Exception objEx)
            {
                return null;
