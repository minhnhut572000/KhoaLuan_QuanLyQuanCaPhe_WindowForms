...
{
    public partial class frmQuanLyLuongNV : DevExpress.XtraEditors.XtraForm
    {
        ...
        public void ExportFile(DataTable dataTable, string sheetName, string title)
        {
            ...
            cl7.Value2 = "Địa chỉ: 399 Phan Huy Ích P.15 Q.Gò Vấp";
            ...
            cl9.Value2 = "Ngày xuất bảng lương: 01/12/2022";
            ...
            cl10.Value2 = "Người xuất: Đỗ Thanh Tùng ";
            ...
            Microsoft.Office.Interop.Excel.Range cl14 = oSheet.get_Range("F16", "G16");
            ...
            Microsoft.Office.Interop.Excel.Range cl15 = oSheet.get_Range("F16", "G16");

            cl15.Value2 = "Đỗ Thanh Tùng";
        ...
        public void ExportFileCTLUONGQL(DataTable dataTable, string sheetName, string title)
        {
            ...
            Microsoft.Office.Interop.Excel.Range cl14 = oSheet.get_Range("G15", "I15");
            ...
            Microsoft.Office.Interop.Excel.Range cl15 = oSheet.get_Range("G15", "I15");
        ...
        private void frmQuanLyLuongNV_Load(object sender, EventArgs e)
        {
            ...
            //btnLuuChamCong.Enabled = btnXoaChamCong.Enabled = false;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                if (luongBLL.XOABANGLUONG(cbb_MaBL.SelectedValue.ToString(), cbb_TenNV.SelectedValue.ToString()))
                {
        ...
        private void btnXuatCTLuongQL_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ExportFileCTLUONGQL(datatable, "Danh sach nhan vien", "CHI TIẾT LƯƠNG NHÂN VIÊN THỜI VỤ");
